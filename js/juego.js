...
function chequearSiGano() {
  var grillaOrdenada = [[1, 2, 3], [4, 5, 6], [7, 8, 9]];
...
function posicionValida(fila, columna) {
  ...
  var filaMaxima = grilla.length - 1;
  var colMaxima = grilla[0].length - 1;
  
  if ((fila >= 0 )&& (fila <= filaMaxima)&& (columna >= 0) && (columna <= colMaxima)) {
    return true;
  }
